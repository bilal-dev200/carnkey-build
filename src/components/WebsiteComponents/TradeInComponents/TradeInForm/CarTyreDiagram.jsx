...
export const CarTyreDiagram = ({ selectedSidebar, damageDetails, setDamageDetails, selectedPart, setSelectedPart, selectedDamageType, setSelectedDamageType, selectedSubcategory, setSelectedSubcategory }) => {
  ...
  const damageOptions = {
    "Rear Left Wheel": {
      types: [
        { name: "Curb Rash", cost: 75 },
        { name: "Bent Rim", cost: 120 },
        { name: "Crack", cost: 150 },
        { name: "Missing Cap", cost: 40 }
      ],
      description: "Rear left wheel damage including rim issues and curb damage.",
      subcategories: [
        { name: "Repair", cost: 0 },
    ...
    "Rear Right Wheel": {
      ...
      description: "Rear right wheel damage including rim issues and curb damage.",
      subcategories: [
        { name: "Repair", cost: 0 },
        { name: "Replace", cost: 200 }
      ],
    ...
    "Front Right Wheel": {
      ...
      description: "Front right wheel damage including rim issues and curb damage.",
      subcategories: [
        { name: "Repair", cost: 0 },
        { name: "Replace", cost: 200 }
      ],
    ...
    "Front Left Wheel": {
      ...
      description: "Front left wheel damage including rim issues and curb damage.",
      subcategories: [
        { name: "Repair", cost: 0 },
        { name: "Replace", cost: 200 }
      ],
  ...
  const handlePartClick = (event) => {
    ...
    if (selectedSidebar === 'Tires' && selectableBodyParts.includes(clickedValue)) {
    ...
    setDamageDetails((prevDetails) => {
      ...
      return {
        ...
        [selectedPart]: {
          ...
          subcategory: null, // reset like before
        },
      };
    });
  };
            ...
            >
              ...
              <g>
                ...
                <circle
                  ...
                  type="Front Wheel"
                  side="left"
                  data-svg-clicked-val="Front Left Wheel"
                  cx="41"
                  cy="50.9"
                  r="14.6"
                  className={`ExtSVGElem ${selectedPart === 'Front Left Wheel' ? 'selected-part' : ''}`}
                  onClick={handlePartClick}
                />
                {/* Left Quarter Panel */}
                <g>
              ...
              <g>
                ...
                <circle
                  ...
                  type="Front Wheel"
                  side="right"
                  data-svg-clicked-val="Front Right Wheel"
                  cx="197.7"
                  cy="50.9"
                  r="14.6"
                  className={`ExtSVGElem ${selectedPart === 'Front Right Wheel' ? 'selected-part' : ''}`}
                  onClick={handlePartClick}
                />
                {/* Right Quarter Panel */}
                <g>
                ...
                <circle
                  ...
                  type="Rear Wheel"
                  side="right"
                  data-svg-clicked-val="Rear Right Wheel"
                  cx="197"
                  cy="187.7"
                  r="14.6"
                  className={`ExtSVGElem ${selectedPart === 'Rear Right Wheel' ? 'selected-part' : ''}`}
                  onClick={handlePartClick}
                />
              </g>
              {/* Front Glass - Right */}
